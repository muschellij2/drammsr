...
[ -n "${COPYRIGHT}" ] || readonly COPYRIGHT='2011, 2012, 2013 University of Pennsylvania'
## @brief Default license of executables.
[ -n "${LICENSE}" ] || readonly LICENSE='See http://www.rad.upenn.edu/sbia/software/license.html or COPYING file.'
## @brief Default contact to use for help output of executables.
[ -n "${CONTACT}" ] || readonly CONTACT='SBIA Group <sbia-software at uphs.upenn.edu>'
