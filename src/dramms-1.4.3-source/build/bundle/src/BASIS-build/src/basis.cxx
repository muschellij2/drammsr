...
static inline bool executing_in_build_tree()
{
    ...
    string rel_path = os::path::relpath(
            ...
            os::path::realpath("/Users/johnmuschelli/Dropbox/Packages/drammsr/src/dramms-1.4.3-source/build/bundle/src/BASIS-build"));
...
string bindir()
{
    if (executing_in_build_tree()) {
        return "/Users/johnmuschelli/Dropbox/Packages/drammsr/src/dramms-1.4.3-source/build/bundle/src/BASIS-build/bin";
    } else {
        return os::path::join(install_prefix(), "lib/basis");
    }
}
...
{
    if (executing_in_build_tree()) {
        return "/Users/johnmuschelli/Dropbox/Packages/drammsr/src/dramms-1.4.3-source/build/bundle/src/BASIS-build/lib";
    } else {
        return os::path::join(install_prefix(), "lib/basis");
    }
}
...
{
    if (executing_in_build_tree()) {
        return "/Users/johnmuschelli/Dropbox/Packages/drammsr/src/dramms-1.4.3-source/build/bundle/src/BASIS/data";
    } else {
        return os::path::join(install_prefix(), "share/basis/data");
    }
}
