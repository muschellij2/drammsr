...
if (MANIFEST_FILE)
  ...
  if (EXISTS "${CMAKE_CURRENT_LIST_DIR}/DRAMMSInstallManifest.txt")
    # install manifest written to installation tree
    set (MANIFEST_FILE "${CMAKE_CURRENT_LIST_DIR}/DRAMMSInstallManifest.txt")
...
if (WIN32 AND REGISTERED)
  set (PKGUID "SBIA-DRAMMS-1.4.1")
  execute_process (
    COMMAND reg delete "HKCU\\Software\\Kitware\\CMake\\Packages\\DRAMMS" /v "${PKGUID}" /f
    RESULT_VARIABLE RT
    ERROR_VARIABLE ERR
  )
  if (RT EQUAL 0)
    message (STATUS "Deregister:   Removed HKCU\\Software\\Kitware\\CMake\\Packages\\DRAMMS\\${PKGUID}")
  else ()
