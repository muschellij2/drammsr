##############################################################################
# @file  DRAMMSConfigVersion.cmake
# @brief Package configuration version file.
#
# @note The DRAMMSConfigVersion.cmake file is automatically
...
#     <td>The package name, i.e., "DRAMMS".</td>
#   </tr>
#   <tr>
#     @tp @b DRAMMS_FIND_VERSION @endtp
#     <td>Full requested version string.</td>
#   </tr>
#   <tr>
#     @tp @b DRAMMS_FIND_VERSION_MAJOR @endtp
#     <td>Major version if requested, else 0.</td>
#   </tr>
#   <tr>
#     @tp @b DRAMMS_FIND_VERSION_MINOR @endtp
#     <td>Minor version if requested, else 0.</td>
#   </tr>
#   <tr>
#     @tp @b DRAMMS_FIND_VERSION_PATCH @endtp
#     <td>Patch version if requested, else 0.</td>
#   </tr>
#   <tr>
#     @tp @b DRAMMS_FIND_VERSION_TWEAK @endtp
#     <td>Tweak version if requested, else 0.</td>
#   </tr>
#   <tr>
#     @tp @b DRAMMS_FIND_VERSION_COUNT @endtp
